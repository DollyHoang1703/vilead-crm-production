  ...
  const quickTemplates = [
    ...
    return (
      <div className="h-full">
        ...
        <div className="border-b border-gray-100 bg-white rounded-t-lg sticky top-0 z-10">
      ...
      {taskView === 'table' ? (
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Chưa làm Column */}
            <div 
              className={`bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full transition-colors ${
                dragOverColumn === 'pending' ? 'ring-2 ring-gray-400 ring-dashed' : ''
              }`}
            ...
            >
              <div className="p-4 border-b border-gray-200 flex items-center justify-between transition-colors">
                <div className="flex items-center">
                  ...
                  <h3 className="font-medium text-gray-900">Chưa làm</h3>
                </div>
                ...
                {displayTasks.filter(task => task.status === 'pending').map((task) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`bg-white rounded-lg shadow-sm border-l-[5px] hover:shadow-md transition-all cursor-move mb-3 ${
                    ...
                    >
                      <div className="p-3 space-y-2">
                        ...
                        {assignee && (
                          <div className="flex items-center gap-2">
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                              ...
                              }`}>{assignee.name.charAt(0)}</span>
                            </div>
                            <span className="text-xs text-gray-700 font-medium">{assignee.name}</span>
                          </div>
                        )}
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                          ...
                          <span className="text-xs text-gray-500">Ngày tạo: {formatDate(task.dueDate)}</span>
                        </div>
                      </div>
                    </div>
                  )
            ...
            <div 
              className={`bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full transition-colors ${
                dragOverColumn === 'in_progress' ? 'ring-2 ring-blue-400 ring-dashed' : ''
              }`}
            ...
            >
              <div className="p-4 border-b border-gray-200 flex items-center justify-between transition-colors">
                <div className="flex items-center">
                  ...
                  <h3 className="font-medium text-gray-900">Đang làm</h3>
                </div>
                ...
                {displayTasks.filter(task => task.status === 'in_progress').map((task) => {
                  ...
                  return (
                    <div 
                      ...
                      draggable
                      onDragStart={(e) => handleDragStart(e, task)}
                      className={`bg-white rounded-lg shadow-sm border-l-[5px] border-l-blue-500 hover:shadow-md transition-all cursor-move mb-3 ${
                        draggedTask?.id === task.id ? 'opacity-50 transform scale-95' : ''
                      }`}
                    >
                      <div className="p-3 space-y-2">
            ...
            <div 
              className={`bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col h-full transition-colors ${
                dragOverColumn === 'completed' ? 'ring-2 ring-green-400 ring-dashed' : ''
              }`}
                ...
                {displayTasks.filter(task => task.status === 'completed').map((task) => {
                  ...
                  return (
                    <div 
                      ...
                      draggable
                      onDragStart={(e) => handleDragStart(e, task)}
                      className={`bg-white rounded-lg shadow-sm border-l-[5px] border-l-green-500 hover:shadow-md transition-all cursor-move mb-3 opacity-90 ${
                    ...
                    >
                      <div className="p-3 space-y-2">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <h4 className="font-medium text-gray-900 text-sm mb-1 line-through">{task.title}</h4>
                            <p className="text-xs text-gray-500">{task.description}</p>
                          </div>
                        </div>
                        ...
                        {assignee && (
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                              <span className="text-xs font-medium text-green-700">{assignee.name.charAt(0)}</span>
                            </div>
                            <span className="text-xs text-gray-700 font-medium">{assignee.name}</span>
                          </div>
                        )}
